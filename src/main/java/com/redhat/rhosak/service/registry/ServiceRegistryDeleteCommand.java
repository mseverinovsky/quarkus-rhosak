...
@CommandLine.Command(name = "delete", mixinStandardHelpOptions = true, description = "Delete a Service Registry instance.")
class ServiceRegistryDeleteCommand extends CustomCommand implements Callable<Integer> {
    ...
    public ServiceRegistryDeleteCommand() {
    ...
    public Integer call() {
        ...
        try {
            ...
            System.err.printf(">>> Service Registry with id='%s' has been deleted!\n", id);
