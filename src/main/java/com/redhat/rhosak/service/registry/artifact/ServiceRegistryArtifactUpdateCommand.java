...
@CommandLine.Command(name = "update", mixinStandardHelpOptions = true, description = "Update artifact")
public class ServiceRegistryArtifactUpdateCommand extends CustomCommand implements Callable<Integer> {
    ...
    public Integer call() {
        ...
        final String ARTIFACT_CREATE_URL = "/apis/registry/v2/groups/default/artifacts/" + artifactId;

        try {
            Map<String, Object> artifactsMap = apiInstanceClient.invokeAPI(
                    ARTIFACT_CREATE_URL, "PUT", null, body,
            ...
            System.out.println(">>> Artifact updated");
            System.out.println("You can view or manage this artifact in your browser by accessing:");
            System.out.printf("https://console.redhat.com/application-services/service-registry/t/%s/artifacts/default/%s/versions/%s\n",
                    serviceRegistry.getId(), artifactsMap.get("id"), artifactsMap.get("version"));
